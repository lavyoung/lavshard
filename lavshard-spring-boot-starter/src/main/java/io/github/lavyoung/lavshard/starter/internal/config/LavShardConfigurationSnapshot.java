 ...
 * @param defaultTransactionIsolation 逻辑连接使用的默认事务隔离级别
 ...
 * @date 2026/09/12
 */
public record LavShardConfigurationSnapshot(Map<String, String> dataSourceBeanNames,
    ...
    public LavShardConfigurationSnapshot {
        ...
        if (!isSupportedTransactionIsolation(defaultTransactionIsolation)) {
            throw new IllegalArgumentException("Unsupported transaction isolation level: " + defaultTransactionIsolation);
        }
