 ...
 * @date 2026/9/11
 */
final class MyBatisCacheKeyAugmenter {

    // Cache protocol identity must remain stable across Java package and class renames.
    private static final String NAMESPACE = "lavshard:mybatis:route:v1";
     ...
     */
    CacheKey augment(CacheKey cacheKey, SqlRouteDecision decision) {
